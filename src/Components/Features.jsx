...
const BentoTilt = ({childern, className=''}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const newTransform = `perspective(700px) rotateX(${tiltX}deg rotateY(${tiltY}deg rotating, scale3d(1, 1, 1)`
    ...
    return (
            ...
            <div className='container mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    <p className='font-circular-web text-lg text-blue-50'>
                        Into the meta game layer</p>
                    <p className='max-w-md font-circular-web text-lg text-blue-50 
            opacity-50'>
                        Immerse yourself in a rich and ever-expanding universa where
        ...
        rounded-md md:h-[65vh]'>
                    <BentoCard
                        ...
                        title={<>radi<b>n</b>t</>}
                        descriptiom='A cross-platform metagame app, turning your 
